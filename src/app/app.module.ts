...
import { MeshGradientComponent } from './proposal-generator/mesh-gradient.component';
import { ProposalRecommendationDetailModule } from './proposal-generator/proposal-recommendation-detail.module';
...
@NgModule({
  ...
  imports: [BrowserModule, CommonModule, FormsModule, AppRoutingModule, LamComponentsModule, ActionCardModule, ButtonModule, FieldControlModule, RadioModule, SearchFieldModule, SectionMessageModule, StepperModule, TabGroupModule, TagModule, MeshGradientComponent, ProposalRecommendationDetailModule],
